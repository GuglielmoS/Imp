...
public class Program {
	...
	public Program(String name, List<Declaration> declarations, List<Statement> statements, SymbolTable table) {
		this.name = name;
	...
	public byte[] compile() {
        ...
        cw.visit(V1_8, ACC_PUBLIC, getName(), null, "java/lang/Object", null);
