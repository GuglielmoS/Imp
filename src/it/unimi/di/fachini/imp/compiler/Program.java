	...
	public byte[] compile() {
        ...
        for (Declaration decl : declarations) {
        	...
        	for (Descriptor descriptor : declaredIdentifiers) {
        		mw.visitLocalVariable(descriptor.getId(), // name
        							  "I", 				  // type (int)
        							  null,				  // signature
        							  null,				  // start label
        							  null,				  // end label
        							  localVariables);	  // index
        		// register the index in the descriptor
        ...
        // push the "Hello World!" String constant
        mw.visitLdcInsn("Program output: ");
        // invoke the 'println' method (defined in the PrintStream class)
        ...
        mw.visitMaxs(10, localVariables);
        mw.visitEnd();
